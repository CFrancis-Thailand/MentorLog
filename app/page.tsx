...
const translations = {
  en: {
    ...
    // Additional Site Dashboard keys
    atOptimalOrEffective: 'at Optimal or Effective',
    fromPrevQuarter: 'from Q4 2024',
    last5Quarters: 'Last 5 Quarters',
    current: 'Current',
    reviewForTransition: 'review for Transition-Ready eligibility',
    vsTarget: 'vs Target',
    quarterlyTrend: 'Quarterly Trend',
    hrs: 'hrs',
    history: 'History',
    supportDecreasing: 'Support decreasing as performance improves',
    indicatorsAtTargetOverTime: 'Indicators at Target Over Time',
    ofSixIndicators: 'of 6 indicators at target',

    // Additional District Dashboard keys
    province: 'Province',
    district: 'District',
    activeFacilities: 'Active Facilities',
    sitesMeetingIndicators: 'Sites Meeting ≥4 Indicators',
    sitesByPathway: 'Sites by Technical Support Pathway',
    siteDistributionByIndicator: 'Site Distribution by Indicator Performance',
    sitesAtOptimalEffective: '% = sites at Optimal/Effective',
    technicalSupportDelivered: 'Technical Support Delivered',
    totalVisits: 'Total Visits',
    commonRootCauses: 'Common Root Causes',
    districtMentor: 'District Mentor',
    faceToFaceShort: 'Face-to-face',
    remoteShort: 'Remote',
    dataReviewShort: 'Data Review',
    trainingShort: 'Training',
    otherShort: 'Other',
    fromPrevQuarterShort: 'from',
  ...
  id: {
    ...
    // Additional Site Dashboard keys
    atOptimalOrEffective: 'pada Optimal atau Efektif',
    fromPrevQuarter: 'dari Q4 2024',
    last5Quarters: '5 Kuartal Terakhir',
    current: 'Saat ini',
    reviewForTransition: 'tinjau kelayakan Siap-Transisi',
    vsTarget: 'vs Target',
    quarterlyTrend: 'Tren Kuartal',
    hrs: 'jam',
    history: 'Riwayat',
    supportDecreasing: 'Dukungan menurun seiring peningkatan kinerja',
    indicatorsAtTargetOverTime: 'Indikator Mencapai Target dari Waktu ke Waktu',
    ofSixIndicators: 'dari 6 indikator mencapai target',

    // Additional District Dashboard keys
    province: 'Provinsi',
    district: 'Kabupaten',
    activeFacilities: 'Fasilitas Aktif',
    sitesMeetingIndicators: 'Fasilitas Memenuhi ≥4 Indikator',
    sitesByPathway: 'Fasilitas menurut Jalur Dukungan Teknis',
    siteDistributionByIndicator: 'Distribusi Fasilitas menurut Kinerja Indikator',
    sitesAtOptimalEffective: '% = fasilitas pada Optimal/Efektif',
    technicalSupportDelivered: 'Dukungan Teknis Diberikan',
    totalVisits: 'Total Kunjungan',
    commonRootCauses: 'Akar Masalah Umum',
    districtMentor: 'Pendamping Kabupaten',
    faceToFaceShort: 'Tatap muka',
    remoteShort: 'Jarak jauh',
    dataReviewShort: 'Telaah Data',
    trainingShort: 'Pelatihan',
    otherShort: 'Lainnya',
    fromPrevQuarterShort: 'dari',
